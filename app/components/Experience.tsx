    ...
    return (
        <section ref={sectionRef} id="experience" className="py-24 px-6">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="relative border-l-2 border-slate-800 ml-4">
                    {experienceData.map((exp, index) => (
                        <div key={index} className="timeline-item relative pl-10 pb-12 last:pb-0">
                            {/* Timeline Dot */}
                            <div className="absolute left-[-9px] top-1 w-4 h-4 bg-purple-400 rounded-full timeline-dot" />

                            {/* Date */}
                            <span className="font-heading text-purple-400 text-sm">{exp.date}</span>
                ...
                {/* Training Block */}
                <div className="training-block mt-12 p-6 bg-purple-400/5 border border-dashed border-purple-400/40 rounded-xl">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h3 className="font-heading text-lg font-bold text-purple-400">
